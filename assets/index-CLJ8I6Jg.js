        ...
        <div class="info-container">
          <div class="project-content-element project-hero">
            ...
            <div class="tech-stack">
              ${i.tech.map(h=>`
                <img src="${Hi.getTechLogoPath(h)}" alt="${h}" title="${h}">
              `).join("")}
            </div>
          </div>    
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Sn,depthTest:!1,depthWrite:!1})}function zo(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:Sn,depthTest:!1,depthWrite:!1})}function Ho(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
